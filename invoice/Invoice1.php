  ...
  <div class="container">
    ...
    <form>
      ...
      <div class="mb-3 text-end">
        <a class="kembali btn btn-secondary" href="tambahinvoice1.php">Tambah INVOICE</a>
      ...
      <table class="table table-bordered">
        ...
        INNER JOIN pegawai ON invoice.nomor_pegawai = pegawai.nomor_pegawai LIMIT $start, $limit");
            while ($data = mysqli_fetch_array($query)) {
                ...
                <td>
				<a class="edit" href="editinvoice.php?nomor_invoice=<?php echo $data['nomor_invoice'];?>" >Edit</a> |
                ...
                <td>	
                <a class="edit" href="notadetail.php?nomor_invoice=<?php echo $data['nomor_invoice']; ?>">Detail</a>	|
