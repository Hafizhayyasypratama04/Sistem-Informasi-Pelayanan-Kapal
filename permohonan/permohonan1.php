  ...
  <div class="container">
    ...
    <form>
      ...
      <div class="mb-3 text-end">
        <a class="kembali btn btn-secondary" href="tambahpermohonan1.php">Tambah Permohonan</a>
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a class="edit btn btn-primary" href="editpermohonan.php?nomor_permohonan=<?php echo $data['nomor_permohonan']; ?>">Edit</a>
              <a class="hapus btn btn-danger" href="hapuspermohonan.php?nomor_permohonan=<?php echo $data['nomor_permohonan']; ?>" onclick="return confirm('Yakin hapus?')">Hapus</a>
            </td>
          </tr>
          <?php } ?>
        </tbody>
