...
<table>
    ...
    <tr>
        <td><a class="kembali" href="permohonan.php">Kembali</a></td>
...
if (isset($_POST['proses'])){
    ...
    header("permohonan.php");
    echo "<script>window.location.href = 'permohonan.php?nomor_permohonan=".$nomor_permohonan."';</script>";
}
?>