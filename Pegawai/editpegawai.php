...
if(isset($_GET['nomor_pegawai'])) {
    ...
    if ($query && mysqli_num_rows($query) > 0) {
        ...
        echo "<script>alert('Data tidak ditemukan'); window.location.href='Pegawai1.php';</script>";
        exit;
    }
}
?>
...
if (isset($_POST['proses'])) {
    ...
    echo "<script>alert('Data berhasil diubah'); window.location.href='Pegawai1.php';</script>";
}
?>
